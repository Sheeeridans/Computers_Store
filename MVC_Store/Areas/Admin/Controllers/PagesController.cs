    ...
    public class PagesController : Controller
    {
        ...
        public ActionResult AddPage(PageVM model)
        {
            ...
            using (Db db = new Db())
            {
                ...
                {
                    ModelState.AddModelError("", "Заголовок не доступен");
                    return View(model);
                }
                else if (db.Pages.Any(x => x.Slug == model.Slug))
                {
                    ModelState.AddModelError("", "Описание не доступно");
                    return View(model);
                }
        ...
        public ActionResult EditPage(int id)
        {
            ...
            using (Db db = new Db())
            {
                ...
                if (dto == null)
                {
                    return Content("Страница недоступна");
                }
        ...
        public ActionResult EditPage(PageVM model)
        {
            ...
            using (Db db = new Db())
            {
                ...
                {
                    ModelState.AddModelError("", "Заголовок недоступен");
                    return View(model);
                }
                else if (db.Pages.Where(x => x.Id != id).Any(x => x.Slug == slug))
                {
                    ModelState.AddModelError("", "Описание недоступно");
                    return View(model);
                }
        ...
        public ActionResult EditSidebar(SidebarVM model)
        {
            ...
            TempData["SM"] = "Вы изменили Sidebar";
